...
<link href="${pageContext.request.contextPath}/jsp/users/css/myCSS.css" rel="stylesheet">
  	...
  	<form action="${pageContext.request.contextPath}/users_resigter"
										id="users_login" method="post" class="login">
										<h3
											style="border-bottom: 1px solid rgba(0, 0, 0, 0.075); font-size: 1.125rem; margin-bottom: 20px; padding-bottom: 17px;">Registration</h3>
										<%
										...
										<p class="form-row form-row-wide">
											<label for="username">First name <span
												...
												placeholder="First Name" id="first_name" value="">
										</p>
										<p class="form-row form-row-wide">
											<label for="username">Last Name<span
												class="required">*</span></label> <input type="text" name="last_name"
												class="input-text form-control validate[required]"
